              ...
              <div className="space-y-4">
                    ...
                    <ResponsiveContainer width="100%" height={160}>
                      <PieChart>
                        <Pie
                          ...
                          innerRadius={35}
                        >
                          {topExpenseCategories.map((_: any, i: number) => (
                ...
                <div className="rounded-xl border bg-card p-4 flex items-center justify-center">
                  <HealthScore
                    score={
                      60 +
                      Math.min(40, Math.round((stats?.savingsRate || 0) * 0.6))
                    }
                  />
                </div>
              </div>
                ...
                <div className="space-y-2">
                  {accounts.slice(0, 5).map((acc) => (
                    ...
                    >
                      ...
                      <p
                        className={`font-semibold text-sm ${acc.balance < 0 ? "text-red-500" : ""}`}
                      >
                    ...
                    <div key={budget.id} className="space-y-2">
                      ...
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, budget.percentage || 0)}%`,
                          }}
                        />
                      </div>
                      ...
                      >
                        ...
                        <div className="h-2 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, goal.percentage || 0)}%`,
